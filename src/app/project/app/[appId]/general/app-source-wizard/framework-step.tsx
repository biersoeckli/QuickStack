                ...
                {jsFrameworkOptions.map((option) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                'relative flex min-h-28 items-center gap-3 rounded-2xl border bg-card p-4 text-left text-card-foreground shadow-xs transition-colors hover:bg-accent focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
