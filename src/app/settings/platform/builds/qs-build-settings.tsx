                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select
                                            ...
                                            items={[
                                                { value: Constants.BUILD_AUTO_NODE_VALUE, label: 'Auto (node with most available resources)' },
                                                { value: Constants.BUILD_NODE_K3S_NATIVE_VALUE, label: 'k3s native' },
                                                ...nodes.map((node) => ({
                                                    value: node.name,
                                                    label: `${node.name}${!node.schedulable ? ' (not schedulable)' : ''}`,
                                                })),
                                            ]}
                                        >
                                            <FormControl>
