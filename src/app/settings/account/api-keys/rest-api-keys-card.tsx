...
import { deleteRestApiKey } from "../profile/actions";
...
export function CreateRestApiKeyButton() {
    ...
    return <Button onClick={handleOpenCreateDialog}>Create REST API Key</Button>
}

export default function RestApiKeysCard({
    initialApiKeys,
    showCreateButton = true,
}: {
    initialApiKeys: RestApiKeyMetadata[]
    ...
    return (
        <Card>
            ...
            {showCreateButton && <CardFooter><CreateRestApiKeyButton /></CardFooter>}
        </Card>
    );
}
