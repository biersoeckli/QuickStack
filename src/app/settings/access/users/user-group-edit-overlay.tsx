...
function RoleEditDialogContent({ userGroup, projects }: {
...
export default function RoleEditOverlay({ children, userGroup, projects }: {
  ...
  return (
    <div
      onClick={() => openDialog(
        <RoleEditDialogContent userGroup={userGroup} projects={projects} />,
        { maxWidth: 'min(1300px, calc(100vw - 2rem))', maxHeight: 'calc(100vh - 2rem)' }
      )}
    >
      {children}
    </div>
