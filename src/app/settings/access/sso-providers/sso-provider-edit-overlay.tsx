...
import { saveSsoProvider } from "../users/actions";
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select
                      ...
                      items={ssoProviderTypes.map((value) => ({ value, label: formatSsoProviderType(value) }))}
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select
                      value={field.value}
                      onValueChange={field.onChange}
                      items={userGroups.map((group) => ({ value: group.id, label: group.name }))}
                    >
                      <FormControl>
                        <SelectTrigger>
