...
import { getAdminUserSession, saveFormAction, simpleAction, fileUploadAction } from "@/server/utils/action-wrapper.utils";
...
const runClusterAddonAction = (
  ...
  simpleAction(async () => {
    ...
    try {
      ...
      revalidatePath('/settings/platform/updates'); // Required because the service has no cache.
    }
  });
