...
INSERT INTO "new_App" ("appType", "buildCommand", "buildMethod", "containerArgs", "containerCommand", "containerImageSource", "containerRegistryPassword", "containerRegistryUsername", "cpuLimit", "cpuReservation", "createdAt", "dockerfilePath", "egressNetworkPolicy", "envVars", "framework", "gitBranch", "gitToken", "gitUrl", "gitUsername", "healthChechHttpGetPath", "healthCheckFailureThreshold", "healthCheckHttpHeadersJson", "healthCheckHttpPort", "healthCheckHttpScheme", "healthCheckPeriodSeconds", "healthCheckTcpPort", "healthCheckTimeoutSeconds", "id", "ingressNetworkPolicy", "installCommand", "memoryLimit", "memoryReservation", "name", "networkPolicyMode", "nodeVersion", "outputDirectory", "projectId", "replicas", "rootDirectory", "runCommand", "securityContextFsGroup", "securityContextPrivileged", "securityContextRunAsGroup", "securityContextRunAsUser", "sourceType", "updatedAt", "useNetworkPolicy", "webhookId") SELECT "appType", "buildCommand", "buildMethod", "containerArgs", "containerCommand", "containerImageSource", "containerRegistryPassword", "containerRegistryUsername", "cpuLimit", "cpuReservation", "createdAt", "dockerfilePath", "egressNetworkPolicy", "envVars", "framework", "gitBranch", "gitToken", "gitUrl", "gitUsername", "healthChechHttpGetPath", "healthCheckFailureThreshold", "healthCheckHttpHeadersJson", "healthCheckHttpPort", "healthCheckHttpScheme", "healthCheckPeriodSeconds", "healthCheckTcpPort", "healthCheckTimeoutSeconds", "id", "ingressNetworkPolicy", "installCommand", "memoryLimit", "memoryReservation", "name", "networkPolicyMode", "nodeVersion", "outputDirectory", "projectId", "replicas", "rootDirectory", "runCommand", "securityContextFsGroup", "securityContextPrivileged", "securityContextRunAsGroup", "securityContextRunAsUser", "sourceType", "updatedAt", "useNetworkPolicy", "webhookId" FROM "App";
DROP TABLE "App";
